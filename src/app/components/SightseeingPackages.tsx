...
export function SightseeingPackages() {
  const { t, language } = useTranslation();
  const { packages } = useApp();

  const sightseeingPackages = packages.filter(pkg => pkg.type === 'sightseeing');
  ...
  return (
    <section id="sightseeing" className="py-16 md:py-24 bg-gray-50">
